...
## APK 下载
[点击下载 APK](apk/TMPortTest_2603152335.apk)
...
### 5) 云端导入/导出命令
为了方便在不同的设备上管理命令，我们做了云端的导入导出功能。
在联网状态下，一台设备上将命令保存到云端以后，在其他任何设备上可以通过导入码快速将命令导入。
可下载APK体验。[点击下载 APK](apk/TMPortTest_2603152335.apk)
![导入方式说明](images/img_no_cmd.jpg)
![命令的导入方式](images/img_no_importcmd.jpg)
> 云端导入涉及到服务器隐私信息，未开源，已经打包成APK文件，下载即可使用。